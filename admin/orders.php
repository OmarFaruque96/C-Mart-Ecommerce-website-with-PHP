                    ...
                    <table class="table datatable dataTable-table">
                      <thead>
                        <tr>
                          ...
                          <th scope="col" data-sortable="" style="width: 10%;"><a href="#" class="dataTable-sorter">Email</a></th>
                          <th scope="col" data-sortable="" style="width: 20%;"><a href="#" class="dataTable-sorter">Phone</a></th>
                          <th scope="col" data-sortable="" style="width: 13%;"><a href="#" class="dataTable-sorter">Address</a></th>
                          <th scope="col" data-sortable="" style="width: 13%;"><a href="#" class="dataTable-sorter">Amount</a></th>
                          <th scope="col" data-sortable="" style="width: 15%;"><a href="#" class="dataTable-sorter">Status</a></th>
                          <th scope="col" data-sortable="" style="width: 16%;"><a href="#" class="dataTable-sorter">Products</a></th>
                      ...
                      <?php 
                      $serial = 0;
                      $orders = mysqli_query($db,"SELECT * FROM mart_orders");
                      ...
                      while($row = mysqli_fetch_assoc($orders)){
                          ...
                          <tr>
                            ...
                            foreach($products as $product){
                              if(!empty($product)){
                                echo findval('p_name','mart_products','ID',$product);
                                echo ',<br>';
                              }
                            }
                              ...
                              <div class="modal fade" id="deleteid<?php echo $id;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-body text-center py-5">
                                        ...
                                        <a class="btn btn-md btn-danger" href="orders.php?data=delete&deleteid=<?php echo $id;?>">Confirm</a>
